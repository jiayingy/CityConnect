...
public class CityConnect {
	...
	public static String executeCommand(String userCommand) {
		...
		return runsMethod(userCommand, commandType);
		/*
		 * ==============NOTE TO STUDENTS======================================
	...
	/**
	 * This operation is used to determines which method to call
	 * based on the user command
	 * 
	 * @param userCommand
	 *           is the full string user has entered as the command
	 * @return the output expected by user
	 */

	private static String runsMethod (String userCommand, COMMAND_TYPE commandType) throws Error {
		switch (commandType) {
			case ADD_ROUTE:
